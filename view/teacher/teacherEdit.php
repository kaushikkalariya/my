...
function save()
{
        document.getElementById('myform').action="index.php?route=college/teacheredit";
}
</script>
<div class="header">
...
<div class="row">
    <div class="col-md-5 col-md-offset-3 table-bordered ">
        ...
        <table class="table text-center table-bordered">
            <tr> 
                <td>Teacher Name:</td>
                <td><input type="text"  id="teacher"name="teacherName" value="<?php echo  $TeacherEditSelect['teacher']['teacher_name']; ?>" />
