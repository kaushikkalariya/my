<?php 
echo 'chr-------'.chr(65)."<br>";
echo 'substr----'.substr('abcdef', 2,2)."<br>";
echo 'ord-------'. ord('A')."<br>";
echo 'strtouppar-'. strtoupper("kaushik")."<br>";
echo 'strtolower-'. strtolower("kaushik")."<br>";
echo 'strlen-----'. strlen('kaushik')."<br>";
echo 'ltrim------'. ltrim("kaushik")."<br>";
echo 'rtrim------'. rtrim("kaushik")."<br>";
echo 'trim-------'. trim("kaushik")."<br>";
echo 'strcmp-----:'. strcmp("Hello", "hello")."<br>";
echo 'strcasecmp-:'. strcasecmp("ello", "HEllo")."<br>";
echo 'strpos-----:'. strpos("kaushikdsfsfs", 's',2)."<br>";
echo 'strrpos----:'. strripos("kaushikkaushiku", 'u', 2)."<br>";
echo 'strstr-----:'. strstr('kaushik', 'h')."<br>";
echo 'stristr----:'. stristr("kaushik",'h' )."<br>";
echo 'strrev-----:'. strrev("kaushik")."<br>";
echo 'strval-----:'. strval("1245.adfsd.4654")."<br>";
$str=array('A', 'B', 'C', 'D',' E');
$arr= implode(',', $str);
echo "implode----:". $arr."<br>";
...
$kk="kalariya";
$bb= str_split($kk);echo "str_split----:";
print_r($bb);echo"<br>";
echo "str_shuffle----:". str_shuffle("kaushik")."<br>";
echo "strcspn--------:". strcspn('kalariya.com', '.');
?>
<!DOCTYPE html>
<html>
<head>
...
<p><input type="text" id="txt" value="Hello World"></p>
<input type="text" id="lbl" name="kk" value="yggutututututs"></label>
