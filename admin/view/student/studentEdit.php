...
function save()
{
        document.getElementById('myform').action="index.php?route=admin/studentedit";
}
</script>
<div class="header">
...
<div class="row">
    <div class="col-md-5 col-md-offset-3 table-bordered ">
        ...
        <form onsubmit="return validateForm()" id="myform" method="post" enctype="multipart/form-data" >      
       <table class="table text-center table-bordered">
            <tr>
                <td class="text-center btn-lg">Course Name:</td>
                <td><input type="text" name="studentName"  id="student"value="<?php print($studentEditSelect['student']['student_name']); ?>" />
