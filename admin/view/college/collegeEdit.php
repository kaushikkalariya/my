...
function save()
{
        document.getElementById('myform').action="index.php?route=admin/collegeedit";
}
</script>
<div class="header">
...
<div class="row">
    <div class="col-md-5 col-md-offset-3 table-bordered ">
        ...
        <table class="table text-center table-bordered">
            <tr> 
                <td>CollegeName:</td>
                <td><input type="text" name="college" id="college" value="<?php  echo $collegeEditSelect['college']['college_name']; ?>"  />
